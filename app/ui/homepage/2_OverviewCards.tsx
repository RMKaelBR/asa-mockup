...
function OverviewCard ({ iconClassname, stat, data } : OverviewCardProps) {
  ...
  return (
    <div className="flex flex-col bg-white rounded-xl shadow relative -inset-y-24 text-center justify-center
      w-44 h-32 m-2
      sm:w-48
      md:w-56 md:h-44 md:m-2
      xl:w-72 xl:m-4
      2xl:w-80 2xl:h-52 2xl:m-4">
      <p className="text-blue-400 text-red-400 sm:text-orange-400 md:text-yellow-400 lg:text-green-400 xl:text-blue-400 2xl:text-violet-400
        text-2xl sm:text-3xl md:text-5xl lg:text-5xl"><i className={iconClassname} /></p>
      <p className="sm:text-xl md:text-2xl font-extrabold text-gray-700 my-2">{stat}</p>
...
export default function OverviewCards () {
  return (
    <div className="overview-container flex justify-center w-9/12 flex-wrap lg:w-full lg:flex-nowrap">
